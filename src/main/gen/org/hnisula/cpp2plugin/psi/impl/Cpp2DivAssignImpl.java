...
public class Cpp2DivAssignImpl extends ASTWrapperPsiElement implements Cpp2DivAssign {

  public Cpp2DivAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Cpp2Visitor visitor) {
    visitor.visitDivAssign(this);
  }
