...
public class Cpp2MathAssignImpl extends ASTWrapperPsiElement implements Cpp2MathAssign {

  public Cpp2MathAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Cpp2Visitor visitor) {
    visitor.visitMathAssign(this);
  }
