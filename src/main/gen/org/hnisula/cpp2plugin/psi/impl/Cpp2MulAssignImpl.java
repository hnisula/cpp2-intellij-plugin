...
public class Cpp2MulAssignImpl extends ASTWrapperPsiElement implements Cpp2MulAssign {

  public Cpp2MulAssignImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Cpp2Visitor visitor) {
    visitor.visitMulAssign(this);
  }
