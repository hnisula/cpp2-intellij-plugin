...
public class Cpp2CaptureExprImpl extends Cpp2ExprImpl implements Cpp2CaptureExpr {

  public Cpp2CaptureExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull Cpp2Visitor visitor) {
    visitor.visitCaptureExpr(this);
  }
