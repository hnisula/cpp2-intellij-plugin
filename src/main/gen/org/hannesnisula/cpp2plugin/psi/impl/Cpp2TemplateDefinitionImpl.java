...
public class Cpp2TemplateDefinitionImpl extends ASTWrapperPsiElement implements Cpp2TemplateDefinition {

  public Cpp2TemplateDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
