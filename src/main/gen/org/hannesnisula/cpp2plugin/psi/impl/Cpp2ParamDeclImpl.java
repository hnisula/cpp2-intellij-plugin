...
public class Cpp2ParamDeclImpl extends ASTWrapperPsiElement implements Cpp2ParamDecl {

  public Cpp2ParamDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public Cpp2ParamKind getParamKind() {
  ...
  public Cpp2VarDecl getVarDecl() {
    return findNotNullChildByClass(Cpp2VarDecl.class);
  }
